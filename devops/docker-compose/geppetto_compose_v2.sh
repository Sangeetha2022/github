...
DESKTOPCODE='../../../geppettotest/application/clients/desktopV2'
...
do
    ...
    c)  
         ...
         ng build
         docker build -t geppettoapp/geppettotest-desktop:2.0 .
         docker run --name geppettoapp -d -p 5051:80 geppettoapp/geppettotest-desktop:2.0
         sleep 10
