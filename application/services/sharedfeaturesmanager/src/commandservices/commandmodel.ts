export const shared_features = [
    ...
    { name: "feature_name", type: "input", message: 'feature_name update/add' },
    { name: "sharing_visibility_status", type: "input", message: 'sharing_visibility_status' },
   //  { name: "type", type: "input", message:"add/update Type" },
   // { name: "description", type: "input", message:"add/update Descrition" },
   // { name: "author_email", type: "input", message:"add/update Author_Email" },
   // { name: "author_name", type: "input", message:"add/update Author_Name" },
   // { name: "organization", type: "input", message:"add/update Organization" },
   // { name: "icon_location", type: "input", message:"add/update Icon_Location" }
 ]
