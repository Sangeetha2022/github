                        ...
                        if (menuElement.featuremenu[0].name.feature !== 'default') {
                            if (menuElement.screenmenu && menuElement.screenmenu.length > 0) {
                                ...
                                menuElement.screenmenu[0].name.screen.forEach((screenElement, screenIndex) => {
                                    if (screenIndex === 0) {
                                        mainNav.push(`<div id="icrvgp" className="cell gpd-clm"  *ngIf="isApplicable('${screenElement.toLowerCase()}') && userId">
                                                        <div id="i6vd27" className="gdp-row gpd-grid"  *ngIf="isApplicable('${screenElement.toLowerCase()}') && userId">
                                                            <div id="inlo1l" className="cell gpd-clm"  *ngIf="isApplicable('${screenElement.toLowerCase()}') && userId">
                                                                <i id="iyxitk" className="fa fa-folder-open" aria-hidden="true"></i>
                                                            </div>
                                                            <div id="iytw4t" className="cell gpd-clm" *ngIf="isApplicable('${screenElement.toLowerCase()}') && userId">
                                    ...
                                    mainNav.push(`<a id="i9imej" className="gpd-text" [routerLink]="['/${screenElement.toLowerCase()}']">{{'source.${menuElement.screenmenu[0].description.screen[screenIndex]}' | i18next}}</a>
                                        </div>
                                    </div>`);
                                });
                            }
                            ...
                            if (menuElement.screenmenu && menuElement.screenmenu.length > 0) {
                                menuElement.screenmenu[0].name.screen.forEach((screenElement, screenIndex) => {
                                    switch (screenElement) {
                                        case 'home':
                                            topNav.push(`<div id="i0xya-2" className="cell gpd-clm">
                                                            <div id="i60c7-2" className="gdp-row gpd-grid">
                                                                <div id="ibuiwl" className="cell gpd-clm"><img id="imvflv" /></div>
                                                                    <div id="icrvgp" className="cell gpd-clm" *ngIf='userId!=null'>
                                                                        <div id="i6vd27" className="gdp-row gpd-grid" *ngIf='userId!=null'>
                                                                            <div id="inlo1l" className="cell gpd-clm" *ngIf='userId!=null'>
                                            ...
                                            break;
                                        case 'sefscreen':
                                            bottomNav.push(`<div id="icrvgp" className="cell gpd-clm" *ngIf='userId!=null'>
                                                                <div id="i6vd27" className="gdp-row gpd-grid" *ngIf='userId!=null'>
                                                                    <div id="inlo1l" className="cell gpd-clm" *ngIf='userId!=null'>
                                        ...
                                        case 'login':
                                            bottomNav.push(`<li>
                                                                <div id="icrvgp" className="cell gpd-clm" *ngIf='userId==null'>
                                                                    <div id="i6vd27" className="gdp-row gpd-grid" *ngIf='userId==null'>
                                                                        ...
                                                                        <div id="iytw4t" className="cell gpd-clm">
                                                                            <a id="i9imej" className="gpd-text" *ngIf='userId==null'
                                            ...
                                            break;
                                        case 'authorization':
                                            bottomNav.push(` <div id="icrvgp" className="cell gpd-clm" *ngIf="isApplicable('${screenElement.toLowerCase()}') && userId">
                                                                <div id="i6vd27" className="gdp-row gpd-grid" *ngIf="isApplicable('${screenElement.toLowerCase()}') && userId">
                                                                    <div id="inlo1l" className="cell gpd-clm" *ngIf="isApplicable('${screenElement.toLowerCase()}') && userId">
                                        ...
                                        case 'manageusers':
                                            ...
                                            break;
                                        case 'admin':
                                            mainNav.push(`<div id="icrvgp" className="cell gpd-clm" *ngIf='isAdminUser'>
                                                            <div id="i6vd27" className="gdp-row gpd-grid" *ngIf='isAdminUser'>
                                                                <div id="inlo1l" className="cell gpd-clm" *ngIf='isAdminUser'>
                                                                    <i id="iyxitk" className="fa fa-user" aria-hidden="true"></i>
                                                                </div>
                                                                <div id="iytw4t" className="cell gpd-clm" *ngIf='isAdminUser'>
                                                                    <a id="i9imej" className="gpd-text"
                                                                    [routerLink]="['/${screenElement.toLowerCase()}']">{{'source.${menuElement.screenmenu[0].description.screen[screenIndex]}'| i18next}}</a>
                                                                </div>
                                                            </div>
                                        ...
                                        case 'logout':
                                            ...
                                            break;
                                        default:
                                            mainNav.push(`<div id="icrvgp" className="cell gpd-clm" *ngIf='userId!=null'>
                                                            <div id="i6vd27" className="gdp-row gpd-grid" *ngIf='userId!=null'>
                                                                <div id="inlo1l" className="cell gpd-clm" *ngIf='userId!=null'>
                                                                    <i id="iyxitk" className="fa fa-home" aria-hidden="true"></i>
                                                                </div>
