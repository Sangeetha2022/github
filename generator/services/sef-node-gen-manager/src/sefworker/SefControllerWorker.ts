...
import { ControllerSupportWorker } from '../sefsupportworker/SefControllerSupportWorker';
...
export class ControllerWorker {
    ...
    createSefController(flowDetail, gpController, entityElement, controllerObj) {
    ...
    generateSefControllerFile(projectGenerationPath, templateLocationPath, Controller) {
        Controller.forEach(ControllerElement => {
            controllerSupportWorker.generateSefControllerFile(projectGenerationPath, templateLocationPath, ControllerElement, (response) => {
