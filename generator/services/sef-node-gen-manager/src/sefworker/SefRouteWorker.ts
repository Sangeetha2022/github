...
import { RouteSupportWorker } from '../sefsupportworker/SefRouteSupportWorker';
...
export class RouteWorker {
    ...
    createSefRoutes(flowDetail, entityElement, RoutesObj) {
    ...
    generateSefRouteFile(projectGenerationPath, templateLocationPath, Routes)   {
        const temp = {
            import: {
                dependencies: []
            },
        ...
        Routes.forEach(RoutesElement => {
            ...
            routeSupportWorker.generateSefRouteFile(projectGenerationPath, templateLocationPath, temp, (response) => {
