...
import { ApiGatewayWorker } from '../sefworker/ApiGatewayWorker';
    ...
    public createApiGateway(req: Request, callback) {
        ...
        asyncLoop(req.body.nodeResponse, (element, next1) => {
            ...
            if (err) {
                ...
                apiGatewayWorker.createSefControllerIndex(apiGatewayGenerationPath, apiGatewayTemplatePath, this.controllerArray);
                apiGatewayWorker.createSefServerFile(apiGatewayGenerationPath, apiGatewayTemplatePath, this.controllerArray, portNumber);
