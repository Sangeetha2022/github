 ...
 * Compiled on Fri Sep 25 2020 16:05:34 GMT+0530 (India Standard Time)
 */
...
r = function(w, rc) {
    ...
    w.popIndentation();
    if (st.test(st.prop(s, g, rc, s.object, "dependencies", { file: gFile, line: 26, column: 52 }))) {
    
        w.write(",\n");
        st.write(w, s, g, rc, (function() {
        var tp = [],
        attr = st.prop(s, g, rc, s.object, "dependencies", { file: gFile, line: 26, column: 79 });
        tp.push(st.makeSubTemplate(g, function(w, rc) {
            var g = this.owningGroup,
            s = this.scope;
            
                     w.write("\t\t \"");
                     st.write(w, s, g, rc, st.prop(s, g, rc, s.dependency, "name", { file: gFile, line: 26, column: 127 }));
                     w.write("\": \"");
                     st.write(w, s, g, rc, st.prop(s, g, rc, s.dependency, "version", { file: gFile, line: 26, column: 148 }));
                     w.write("\" ");
            }, [
            { name: "dependency"     }
            ])); 
