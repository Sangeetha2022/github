...
resource "aws_vpc" "demo" {
  ...
  tags = "${map( "Name", "auto-eks-demo-node","kubernetes.io/cluster/${var.cluster-name}", "shared",)}"
}
...
# Worker Node AutoScaling launch
