...
export class AppPodService {
    ...
    public system_entry_pod(projectDetails, callback: CallableFunction) {
        ...
        async function applyReDeploySytemEntry() {
            try {
                ...
                console.log("System-entry-pod Redeployed!");
                await delay(5000);
    ...
    public generator_pod(projectDetails, callback: CallableFunction) {
