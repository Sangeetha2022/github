import { GeppettoLanding } from './TopNavLanding';
...
import { GeppettoHeader } from './TopNavHeader';
import { GeppettoSideNav } from './TopNav';
import { Footer } from './TopNavFooter';
...
export class TopTemplateGenerator {
