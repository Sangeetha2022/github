export class Constant {
    ...
    // fileName
    public static APP_ROUTING_FILENAME = 'routes.tsx';
    ...
    public static AGGRID_TAGNAME = 'ag-grid-react';
    ...
    * { 
    ...
    .tableBg{
        ...
        border-radius: 10px;
        box-shadow: 0 3px 6px 0 rgba(36, 35, 35, 0.2);
