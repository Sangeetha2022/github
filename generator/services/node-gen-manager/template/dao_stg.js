/*
 * Template group dao
 * Compiled on Sat Jun 01 2019 15:42:05 GMT+0530 (India Standard Time)
 */
...
r = function(w, rc) {
    ...
    w.popIndentation();
    w.write("\n");
    if (st.test(st.prop(s, g, rc, s.object, "flowAction", { file: gFile, line: 8, column: 11 }))) {
    
        st.write(w, s, g, rc, (function() {
        var tp = [],
        attr = st.prop(s, g, rc, s.object, "flowAction", { file: gFile, line: 8, column: 31 });
        tp.push(st.makeSubTemplate(g, function(w, rc) {
            var g = this.owningGroup,
            s = this.scope;
            
                     w.write("public ");
                     st.write(w, s, g, rc, st.prop(s, g, rc, s.flowObj, "methodName", { file: gFile, line: 8, column: 69 }));
                     w.write("(");
                     st.write(w, s, g, rc, st.prop(s, g, rc, s.flowObj, "parameter", { file: gFile, line: 8, column: 90 }));
                     w.write("){\n");
                     if (st.test(st.prop(s, g, rc, s.flowObj, "variable", { file: gFile, line: 8, column: 118 }))) {
                     
                         st.write(w, s, g, rc, st.prop(s, g, rc, s.flowObj, "variable", { file: gFile, line: 8, column: 137 }));
                         w.write(";");
                     
                     
                     }
                     w.write("\nthis.");
                     st.write(w, s, g, rc, st.prop(s, g, rc, s.flowObj, "verbs", { file: gFile, line: 8, column: 172 }));
                     w.write("(");
                     if (st.test(st.prop(s, g, rc, s.flowObj, "query", { file: gFile, line: 8, column: 191 }))) {
                     
                         st.write(w, s, g, rc, st.prop(s, g, rc, s.flowObj, "query", { file: gFile, line: 8, column: 207 }));
