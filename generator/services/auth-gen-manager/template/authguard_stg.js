...
r = function(w, rc) {
    ...
    w.write("\n");
    w.pushIndentation("    ");
    w.write("this.route.events.filter(value => value instanceof GuardsCheckStart).subscribe((value: GuardsCheckStart) => {");
    w.popIndentation();
    w.write("\n");
    w.pushIndentation("      ");
    w.write("console.log('--------routevalue----', this.route.config);");
    w.popIndentation();
    w.write("\n");
    w.pushIndentation("      ");
    ...
    w.write("\n");
    w.pushIndentation("          ");
    w.write("let Admin = element['Admin'];");
    w.popIndentation();
    w.write("\n");
    w.pushIndentation("          ");
    w.write("let Developer = element['Developer'];");
    w.popIndentation();
    w.write("\n");
    w.pushIndentation("          ");
    w.write("let Guest = element['Guest'];");
    w.popIndentation();
    w.write("\n");
    w.pushIndentation("          ");
    w.write("let StandardUser = element['Standard User'];");
    w.popIndentation();
    w.write("\n");
    w.pushIndentation("          ");
    ...
    w.write("\n");
    w.pushIndentation("            ");
    w.write("const permissionlevel = JSON.parse(Admin.value);");
    w.popIndentation();
    w.write("\n");
    w.pushIndentation("            ");
    ...
    w.write("\n");
    w.pushIndentation("                    ");
    w.write("this.broadcastService.sendMessage({ 'Admin': this.permissions });");
    w.popIndentation();
    w.write("\n");
    w.pushIndentation("                  ");
    w.write("}");
    ...
    w.write("\n");
    w.pushIndentation("            ");
    w.write("const permissionlevel = JSON.parse((Developer.value));");
    w.popIndentation();
    w.write("\n");
    w.pushIndentation("            ");
    w.write("for (let key in permissionlevel) {");
    ...
    w.write("\n");
    w.pushIndentation("                    ");
    w.write("this.broadcastService.sendMessage({ 'Developer': this.permissions });");
    w.popIndentation();
    w.write("\n");
    w.pushIndentation("                  ");
    w.write("}");
    ...
    w.write("\n");
    w.pushIndentation("            ");
    w.write("const permissionlevel = JSON.parse((StandardUser.value));");
    w.popIndentation();
    w.write("\n");
    w.pushIndentation("            ");
    w.write("for (let key in permissionlevel) {");
    ...
    w.write("\n");
    w.pushIndentation("                    ");
    w.write("this.broadcastService.sendMessage({ 'User': this.permissions });");
    w.popIndentation();
    w.write("\n");
    w.pushIndentation("                  ");
    w.write("}");
    ...
    w.write("\n");
    w.pushIndentation("          ");
    w.write("if (this.userRole == 'Guest') {");
    w.popIndentation();
    w.write("\n");
    w.pushIndentation("            ");
    w.write("const permissionlevel = JSON.parse((Guest.value));");
    w.popIndentation();
    w.write("\n");
    w.pushIndentation("            ");
    w.write("for (let key in permissionlevel) {");
    ...
    w.write("\n");
    w.pushIndentation("                    ");
    w.write("this.broadcastService.sendMessage({ 'Guest': this.permissions });");
    w.popIndentation();
    w.write("\n");
    w.pushIndentation("                  ");
    w.write("}");
