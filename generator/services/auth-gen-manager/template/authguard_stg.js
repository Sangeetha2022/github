 ...
 * Compiled on Fri Nov 19 2021 12:13:59 GMT+0530 (India Standard Time)
 */
...
r = function(w, rc) {
    ...
    w.write("\n");
    w.write("import  *  as  global_lang_json from 'src/assets/user.json';");
    w.write("\n");
    w.write("\n");
    w.write("@Injectable({");
    w.write("\n");
    ...
    w.write("\n");
    w.pushIndentation("  ");
    w.write("catalogscreen:any;");
    w.popIndentation();
    w.write("\n");
    w.pushIndentation("  ");
    w.write("searchscreen:any;");
    w.popIndentation();
    w.write("\n");
    w.pushIndentation("  ");
    ...
    w.write("\n");
    w.pushIndentation("    ");
    w.write("const json1=global_lang_json;");
    w.popIndentation();
    w.write("\n");
    w.pushIndentation("    ");
    ...
    w.write("\n");
    w.pushIndentation("      ");
    w.write("console.log('this.json ', json1.access);");
    w.popIndentation();
    w.write("\n");
    w.write("\n");
    w.pushIndentation("      ");
    ...
    w.write("\n");
    w.pushIndentation("          ");
    w.write("const catalog_screen = useraccess['catalog screen'];");
    w.popIndentation();
    w.write("\n");
    w.pushIndentation("          ");
    w.write("const search_screen = useraccess['search screen'];");
    w.popIndentation();
    w.write("\n");
    w.pushIndentation("          ");
    w.write("catalog_screen.forEach((access: { access: { value: any; }; components: any; }) => {");
    w.popIndentation();
    w.write("\n");
    w.pushIndentation("            ");
    w.write("this.catalogscreen={");
    w.popIndentation();
    w.write("\n");
    w.pushIndentation("               ");
    ...
    w.write("\n");
    w.pushIndentation("          ");
    w.write("search_screen.forEach((access: { access: { value: any; }; components: any; }) => {");
    w.popIndentation();
    w.write("\n");
    w.pushIndentation("            ");
    w.write("this.searchscreen={");
    w.popIndentation();
    w.write("\n");
    w.pushIndentation("               ");
    w.write("'Components': access.components");
    ...
    w.write("\n");
    w.pushIndentation("           ");
    w.write("this.broadcastService.sendMessage({ 'catalog_screen': this.catalogscreen, 'search_screen': this.searchscreen,'screens': this.user_scr_permissions });");
    w.popIndentation();
    w.write("\n");
    w.pushIndentation("        ");
    w.write("}");
    ...
    w.write("\n");
    w.pushIndentation("          ");
    w.write("const catalog_screen = adminaccess['catalog screen'];");
    w.popIndentation();
    w.write("\n");
    w.pushIndentation("          ");
    w.write("const search_screen = adminaccess['search screen'];");
    w.popIndentation();
    w.write("\n");
    w.pushIndentation("          ");
    w.write("catalog_screen.forEach((access: { access: { value: any; }; components: any; }) => {");
    ...
    w.write("\n");
    w.pushIndentation("          ");
    w.write("this.broadcastService.sendMessage({ 'catalog_screen': this.catalogscreen, 'search_screen': this.searchscreen,'screens': this.admin_scr_permissions });");
    w.popIndentation();
    w.write("\n");
    w.pushIndentation("        ");
    w.write("}");
