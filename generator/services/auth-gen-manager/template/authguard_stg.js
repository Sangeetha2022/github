 ...
 * Compiled on Sun Sep 01 2019 01:12:34 GMT+0530 (IST)
 */
...
r = function(w, rc) {
    ...
    w.write("\n");
    w.pushIndentation("         ");
    w.write("if (this.routeName.includes('profile?id=')) {");
    w.popIndentation();
    w.write("\n");
    w.pushIndentation("          ");
    w.write("this.routename = this.routeName.split('?');");
    w.popIndentation();
    w.write("\n");
    w.pushIndentation("          ");
    w.write("this.routeName = this.routename[0];");
    w.popIndentation();
    w.write("\n");
    w.pushIndentation("        ");
    w.write("}");
    ...
    w.write("\n");
    w.pushIndentation("        ");
    w.write("if (this.routeName === 'profile') {");
    w.popIndentation();
    w.write("\n");
    w.pushIndentation("          ");
    w.write("if (this.viewPermission !== 'true') {");
    ...
    w.write("\n");
    w.pushIndentation("        ");
    w.write("if (this.routeName === 'usermanagement') {");
    w.popIndentation();
    w.write("\n");
    w.pushIndentation("          ");
    w.write("if (this.viewPermission !== 'true') {");
